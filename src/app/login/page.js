...
import { loginUser } from "@/store/userSlice"; // Adjust path to your Redux slice
...
const Login = () => {
  ...
  const from = searchParams.get("from") || (loginType === "employer" ? "/empdashboard" : "/caddetails");
  ...
  // Render Login component if loginType is set
  return (
    <section className="min-h-screen p-4 sm:p-6 md:p-8 flex items-center justify-center bg-gray-50">
